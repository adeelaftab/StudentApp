...
const AnnouncementScreen = (props) => {
    const _renderAnnouncement = () => {
        const [visibility, setVisibility] = useState<boolean>(props.MakeVisible);
            ...
            return (
                <View style={AnnouncementStyles.background}>
                    ...
                    <View style={AnnouncementStyles.MessageTextView}>
                        <Text style={[AnnouncementStyles.MessageText, FontFamily.arabicRegular]}>
                            {translation.AnnouncementScreen.MessageText}
                        </Text>
                    </View>                    
                    <TouchableOpacity onPress={_handleAnnouncement} style={AnnouncementStyles.ConfirmButton}>
                        <Text style={[AnnouncementStyles.ConfirmButtonText, FontFamily.arabicRegular]}>
