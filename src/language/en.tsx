export default {
  ...
  AnnouncementScreen: {
    ...
    MessageText:
      `Management's interest, Respected Students Make sure that you do not have videos not yet uploaded for the final exams, To finalize it, please follow the following steps:\n` +
